...
public class FamilyService {
    ...
    @Transactional
    public FamilyResponseDTO createFamily(FamilyRequestDTO req) {
        ...
        family.parish = parishContext.resolveParish(req.parishId());
    ...
    @Transactional
    public FamilyResponseDTO updateFamily(FamilyUpdateDTO req, Long id) {
